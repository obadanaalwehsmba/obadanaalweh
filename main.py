...
async def get_voice_list_async():
    ...
    def get_language_name(locale):
        language_map = {
            ...
            "sr": "اللغة الصربية",
            "bg": "اللغة البلغارية",
            "az": "اللغة الأذربيجانية",
            "my": "اللغة البورمية",
            "ca": "اللغة الكاتالانية",
            "sq": "اللغة الألبانية",
            "af": "اللغة الأفريكانية",
            "bs": "اللغة البوسنية",
            "am": "اللغة الأمهرية",
            "bn": "اللغة البنغالية",
            "gl": "اللغة الجاليكية",
            "gu": "اللغة الغوجاراتية",
            "he": "اللغة العبرية",
            "hu": "اللغة الهنغارية",
            "ka": "اللغة الجورجية",
            "ml": "اللغة المالايالامية",
            "mr": "اللغة الماراثية",
            "mt": "اللغة المالطية",
            "mk": "اللغة المقدونية",
            "ps": "اللغة الباشتو",
